 ...
 * Page class
 */
#[AsAlias("AccessoriesEdit", true)]
class AccessoriesEdit extends Accessories implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "AccessoriesEdit"; // Route action
    ...
    public function run(): void
    {
        ...
        if (IsApi()) {
            ...
            if ($this->isShow()) {
                if (!$this->CurrentRecord) { // No record found
                    ...
                    $this->terminate("AccessoriesList"); // Return to list page
                    return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("AccessoriesList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "AccessoriesList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "AccessoriesList") {
                            ...
                            $returnUrl = "AccessoriesList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate();
                    } else {
                        if ($this->IsModal && GetPageName($returnUrl) != "AccessoriesList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("AccessoriesList")); // Refresh page after edit before going to return page
    ...
    protected function loadFormValues(): void
    {
        ...
        // accessory_name
        if (!$this->accessory_name->IsDetailKey) {
            $val = $this->hasInputValue($this->accessory_name) ? $this->getInputValue($this->accessory_name) : null;
            $this->accessory_name->setFormValue($val);
        }
    ...
    public function restoreFormValues(): void
    {
        ...
        $this->accessory_name->CurrentValue = $this->accessory_name->FormValue;
    ...
    public function renderRow(RowType $rowType = RowType::VIEW, bool $resetAttributes = true): void
    {
        ...
        // accessory_name
        $this->accessory_name->RowCssClass = "row";
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // accessory_name
            $this->accessory_name->setupEditAttributes();
            $this->accessory_name->EditValue = !$this->accessory_name->Raw ? HtmlDecode($this->accessory_name->CurrentValue) : $this->accessory_name->CurrentValue;
            $this->accessory_name->PlaceHolder = RemoveHtml($this->accessory_name->caption());
    ...
    protected function validateForm(): bool
    {
        ...
        if ($this->accessory_name->Visible) {
            if ($this->accessory_name->Required) {
                if (!$this->accessory_name->IsDetailKey && IsEmpty($this->accessory_name->FormValue)) {
                    $this->accessory_name->addErrorMessage(str_replace("%s", $this->accessory_name->caption(), $this->accessory_name->RequiredErrorMessage));
                }
            }
        }
    ...
    protected function getEditRow(BaseEntity $newRow): BaseEntity
    {
        ...
        // accessory_name
        if (!$this->accessory_name->ReadOnly) {
            $newRow->setAccessoryName($this->accessory_name->setDbValueDef($this->accessory_name->CurrentValue));
        }
    ...
    protected function setupBreadcrumb(): void
    {
        ...
        $url = CurrentUrl();
        $breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AccessoriesList"), "", $this->TableVar, true);
        $pageId = "edit";
