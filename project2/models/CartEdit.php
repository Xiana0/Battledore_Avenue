 ...
 * Page class
 */
#[AsAlias("CartEdit", true)]
class CartEdit extends Cart implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "CartEdit"; // Route action
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if (IsJsonResponse()) {
                        ...
                        if ($this->IsModal && GetPageName($returnUrl) != "CartList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("CartList")); // Refresh page after edit before going to return page
