 ...
 * Page class
 */
#[AsAlias("OrderItemsDelete", true)]
class OrderItemsDelete extends OrderItems implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "OrderItemsDelete"; // Route action
    ...
    public function run(): void
    {
        ...
        if (empty($this->Records) && !$this->CurrentRecord) {
            $this->terminate("OrderItemsList"); // Prevent SQL injection, return to list
            return;
        }
