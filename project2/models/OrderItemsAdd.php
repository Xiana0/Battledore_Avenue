 ...
 * Page class
 */
#[AsAlias("OrderItemsAdd", true)]
class OrderItemsAdd extends OrderItems implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "OrderItemsAdd"; // Route action
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($newRow = $this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "OrderItemsView") {
                    ...
                    if (IsJsonResponse()) {
                        ...
                        if ($this->IsModal && GetPageName($returnUrl) != "OrderItemsList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("OrderItemsList")); // Refresh page after add before going to return page
