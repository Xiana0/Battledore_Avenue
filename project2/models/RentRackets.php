...
/**
 * Table class for rent_rackets
 */
#[AsAlias("RentRackets", true)]
#[AsAlias("rent_rackets", true)]
#[AsEntityListener(event: Events::postPersist, method: 'clearCache', entity: Entity\RentRacket::class)]
#[AsEntityListener(event: Events::postUpdate, method: 'clearCache', entity: Entity\RentRacket::class)]
#[AsEntityListener(event: Events::postRemove, method: 'clearCache', entity: Entity\RentRacket::class)]
#[AsEntityListener(event: Events::postPersist, method: 'updateLastInsertId', entity: Entity\RentRacket::class)]
#[AsEntityListener(event: Events::preUpdate, method: 'preUpdate', entity: Entity\RentRacket::class)]
class RentRackets extends DbTable implements LookupTableInterface
{
    ...
    // Fields
    public DbField $id;
    public DbField $racket_name;
    public DbField $brand;
    public DbField $price_per_day;
    public DbField $image;
    ...
    public function __construct(
        ...
        $this->EntityClass = Entity\RentRacket::class;
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // racket_name
        $this->racket_name = $this->Fields['racket_name'];

        // brand
        $this->brand = $this->Fields['brand'];

        // price_per_day
        $this->price_per_day = $this->Fields['price_per_day'];
    ...
    public function getFieldDefinitions(): array
    {
        return [
            ...
            'racket_name' => [
                'FieldVar' => 'x_racket_name', // Field variable name
                'Param' => 'racket_name', // Field parameter name (Table class property name)
                'PropertyName' => 'racketName', // Field entity property name
                'Expression' => '`racket_name`', // Field expression (used in SQL)
                'BasicSearchExpression' => '`racket_name`', // Field expression (used in basic search SQL)
                'Type' => 200, // Field type
                'DataType' => DataType::STRING, // Field data type (DataType::XXX)
                'ParameterType' => ParameterType::STRING, // Field Doctrine parameter type
                'Size' => 100, // Field size
                'DateTimeFormat' => -1, // Date time format
                'VirtualExpression' => '`racket_name`', // Virtual field expression (used in ListSQL)
                'IsVirtual' => false, // Virtual field
                'ForceSelection' => false, // Autosuggest force selection
                'VirtualSearch' => false, // Search as virtual field
                'ViewTag' => 'FORMATTED TEXT', // View Tag
            ...
            'brand' => [
                'FieldVar' => 'x_brand', // Field variable name
                'Param' => 'brand', // Field parameter name (Table class property name)
                'PropertyName' => 'brand', // Field entity property name
                'Expression' => '`brand`', // Field expression (used in SQL)
                'BasicSearchExpression' => '`brand`', // Field expression (used in basic search SQL)
                'Type' => 200, // Field type
                'DataType' => DataType::STRING, // Field data type (DataType::XXX)
                'ParameterType' => ParameterType::STRING, // Field Doctrine parameter type
                'Size' => 100, // Field size
                'DateTimeFormat' => -1, // Date time format
                'VirtualExpression' => '`brand`', // Virtual field expression (used in ListSQL)
                'IsVirtual' => false, // Virtual field
                'ForceSelection' => false, // Autosuggest force selection
                'VirtualSearch' => false, // Search as virtual field
                'ViewTag' => 'FORMATTED TEXT', // View Tag
            ...
            'price_per_day' => [
                'FieldVar' => 'x_price_per_day', // Field variable name
                'Param' => 'price_per_day', // Field parameter name (Table class property name)
                'PropertyName' => 'pricePerDay', // Field entity property name
                'Expression' => '`price_per_day`', // Field expression (used in SQL)
                'BasicSearchExpression' => '`price_per_day`', // Field expression (used in basic search SQL)
                'Type' => 131, // Field type
                'DataType' => DataType::NUMBER, // Field data type (DataType::XXX)
                'ParameterType' => ParameterType::STRING, // Field Doctrine parameter type
                'Size' => 12, // Field size
                'DateTimeFormat' => -1, // Date time format
                'VirtualExpression' => '`price_per_day`', // Virtual field expression (used in ListSQL)
                'IsVirtual' => false, // Virtual field
                'ForceSelection' => false, // Autosuggest force selection
                'VirtualSearch' => false, // Search as virtual field
                'ViewTag' => 'FORMATTED TEXT', // View Tag
            ...
            'image' => [
                'FieldVar' => 'x_image', // Field variable name
                'Param' => 'image', // Field parameter name (Table class property name)
                'PropertyName' => 'image', // Field entity property name
                'Expression' => '`image`', // Field expression (used in SQL)
                'BasicSearchExpression' => '`image`', // Field expression (used in basic search SQL)
                'Type' => 200, // Field type
                'DataType' => DataType::STRING, // Field data type (DataType::XXX)
                'ParameterType' => ParameterType::STRING, // Field Doctrine parameter type
                'Size' => 255, // Field size
                'DateTimeFormat' => -1, // Date time format
                'VirtualExpression' => '`image`', // Virtual field expression (used in ListSQL)
                'IsVirtual' => false, // Virtual field
                'ForceSelection' => false, // Autosuggest force selection
                'VirtualSearch' => false, // Search as virtual field
                'ViewTag' => 'FORMATTED TEXT', // View Tag
            ...
            'stock' => [
                'FieldVar' => 'x_stock', // Field variable name
                'Param' => 'stock', // Field parameter name (Table class property name)
                'PropertyName' => 'stock', // Field entity property name
                'Expression' => '`stock`', // Field expression (used in SQL)
                'BasicSearchExpression' => '`stock`', // Field expression (used in basic search SQL)
                'Type' => 3, // Field type
                'DataType' => DataType::NUMBER, // Field data type (DataType::XXX)
                'ParameterType' => ParameterType::INTEGER, // Field Doctrine parameter type
                'Size' => 11, // Field size
                'DateTimeFormat' => -1, // Date time format
                'VirtualExpression' => '`stock`', // Virtual field expression (used in ListSQL)
                'IsVirtual' => false, // Virtual field
                'ForceSelection' => false, // Autosuggest force selection
                'VirtualSearch' => false, // Search as virtual field
                'ViewTag' => 'FORMATTED TEXT', // View Tag
    ...
    {
        return $this->sqlFrom ?? "rent_rackets";
    }
     ...
     */
    public function clearCache(Entity\RentRacket $row, LifecycleEventArgs $args): void
    {
        // Clear lookup cache
    ...
    protected function loadDbValues(?BaseEntity $row)
    {
        ...
        $this->racket_name->DbValue = $row->getRacketName();
        $this->brand->DbValue = $row->getBrand();
        $this->price_per_day->DbValue = $row->getPricePerDay();
        $this->image->DbValue = $row->getImage();
        $this->stock->DbValue = $row->getStock();
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("RentRacketsList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "RentRacketsView" => $this->language->phrase("View"),
            "RentRacketsEdit" => $this->language->phrase("Edit"),
            "RentRacketsAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getViewUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("RentRacketsView", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RentRacketsView", [$param]);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = BuildUrl("RentRacketsAdd", $param);
        return $this->addMasterUrl($url);
    }
    ...
    public function getEditUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("RentRacketsEdit", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RentRacketsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RentRacketsEdit", [$param]);
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("RentRacketsAdd", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RentRacketsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $param = ""): string
    {
        if ($this->UseAjaxActions && IsInfiniteScroll() && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("RentRacketsDelete", $param);
        }
    }
    ...
    public function renderListContent(array|BaseEntity $data, int $totalRecords)
    {
        global $httpContext;
        $container = Container();
        $page = $container->get("RentRacketsList");
        if (is_array($data)) {
        ...
        if (!$doc->ExportCustom && $writeHeader) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->racket_name);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->racket_name);
    ...
    public function updateLastInsertId(Entity\RentRacket $row, LifecycleEventArgs $args)
    {
        $this->id->setDbValue($row['id']);
    }

    // Save entity change set
    public function preUpdate(Entity\RentRacket $row, PreUpdateEventArgs $args): void
    {
    ...
    public function preRemove(Entity\RentRacket $row, LifecycleEventArgs $args): void
    {
