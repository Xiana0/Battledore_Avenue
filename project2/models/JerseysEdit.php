 ...
 * Page class
 */
#[AsAlias("JerseysEdit", true)]
class JerseysEdit extends Jerseys implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "JerseysEdit"; // Route action
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if (IsJsonResponse()) {
                        ...
                        if ($this->IsModal && GetPageName($returnUrl) != "JerseysList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("JerseysList")); // Refresh page after edit before going to return page
