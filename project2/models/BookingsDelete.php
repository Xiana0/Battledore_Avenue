 ...
 * Page class
 */
#[AsAlias("BookingsDelete", true)]
class BookingsDelete extends Bookings implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "BookingsDelete"; // Route action
    ...
    public function run(): void
    {
        ...
        if (empty($this->Records) && !$this->CurrentRecord) {
            $this->terminate("BookingsList"); // Prevent SQL injection, return to list
            return;
        }
