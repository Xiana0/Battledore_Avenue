 ...
 * Page class
 */
#[AsAlias("RentRacketsAdd", true)]
class RentRacketsAdd extends RentRackets implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "RentRacketsAdd"; // Route action
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($newRow = $this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "RentRacketsView") {
                    ...
                    if (IsJsonResponse()) {
                        ...
                        if ($this->IsModal && GetPageName($returnUrl) != "RentRacketsList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("RentRacketsList")); // Refresh page after add before going to return page
