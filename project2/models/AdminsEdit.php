 ...
 * Page class
 */
#[AsAlias("AdminsEdit", true)]
class AdminsEdit extends Admins implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "AdminsEdit"; // Route action
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if (IsJsonResponse()) {
                        ...
                        if ($this->IsModal && GetPageName($returnUrl) != "AdminsList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("AdminsList")); // Refresh page after edit before going to return page
