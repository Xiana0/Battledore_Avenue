 ...
 * Page class
 */
#[AsAlias("AccessoriesAdd", true)]
class AccessoriesAdd extends Accessories implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "AccessoriesAdd"; // Route action
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($newRow = $this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AccessoriesView") {
                    ...
                    if (IsJsonResponse()) {
                        ...
                        if ($this->IsModal && GetPageName($returnUrl) != "AccessoriesList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("AccessoriesList")); // Refresh page after add before going to return page
    ...
    protected function getAddRow(): object
    {
        ...
        // stock
        if (!IsEmpty(strval($this->stock->CurrentValue))) {
