 ...
 * Page class
 */
#[AsAlias("JerseysDelete", true)]
class JerseysDelete extends Jerseys implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "JerseysDelete"; // Route action
    ...
    public function run(): void
    {
        ...
        if (empty($this->Records) && !$this->CurrentRecord) {
            $this->terminate("JerseysList"); // Prevent SQL injection, return to list
            return;
        }
