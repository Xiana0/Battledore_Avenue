 ...
 * Page class
 */
#[AsAlias("OrderItemsView", true)]
class OrderItemsView extends OrderItems implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "OrderItemsView"; // Route action
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "OrderItemsList"; // Return to list
        }
