 ...
 * Page class
 */
#[AsAlias("BookingsView", true)]
class BookingsView extends Bookings implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "BookingsView"; // Route action
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "BookingsList"; // Return to list
        }
