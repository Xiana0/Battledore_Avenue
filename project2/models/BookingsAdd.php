 ...
 * Page class
 */
#[AsAlias("BookingsAdd", true)]
class BookingsAdd extends Bookings implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "BookingsAdd"; // Route action
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($newRow = $this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "BookingsView") {
                    ...
                    if (IsJsonResponse()) {
                        ...
                        if ($this->IsModal && GetPageName($returnUrl) != "BookingsList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("BookingsList")); // Refresh page after add before going to return page
