 ...
 * Page class
 */
#[AsAlias("AdminsDelete", true)]
class AdminsDelete extends Admins implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "AdminsDelete"; // Route action
    ...
    public function run(): void
    {
        ...
        if (empty($this->Records) && !$this->CurrentRecord) {
            $this->terminate("AdminsList"); // Prevent SQL injection, return to list
            return;
        }
