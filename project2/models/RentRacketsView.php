 ...
 * Page class
 */
#[AsAlias("RentRacketsView", true)]
class RentRacketsView extends RentRackets implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "RentRacketsView"; // Route action
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "RentRacketsList"; // Return to list
        }
