 ...
 * Page class
 */
#[AsAlias("OrdersEdit", true)]
class OrdersEdit extends Orders implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "OrdersEdit"; // Route action
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if (IsJsonResponse()) {
                        ...
                        if ($this->IsModal && GetPageName($returnUrl) != "OrdersList") {
                            $this->IsModal = false;
                            FlashBag()->add("X-Refresh-Url", GetUrl("OrdersList")); // Refresh page after edit before going to return page
