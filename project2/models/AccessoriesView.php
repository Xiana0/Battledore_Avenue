 ...
 * Page class
 */
#[AsAlias("AccessoriesView", true)]
class AccessoriesView extends Accessories implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "AccessoriesView"; // Route action
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AccessoriesList"; // Return to list
        }
