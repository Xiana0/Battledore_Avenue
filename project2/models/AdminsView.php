 ...
 * Page class
 */
#[AsAlias("AdminsView", true)]
class AdminsView extends Admins implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "AdminsView"; // Route action
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AdminsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->CurrentRecord) { // No current record
                    ...
                    $this->terminate("AdminsList"); // Return to list page
                    return;
