 ...
 * Page class
 */
#[AsAlias("RentRacketsDelete", true)]
class RentRacketsDelete extends RentRackets implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "RentRacketsDelete"; // Route action
    ...
    public function run(): void
    {
        ...
        if (empty($this->Records) && !$this->CurrentRecord) {
            $this->terminate("RentRacketsList"); // Prevent SQL injection, return to list
            return;
        }
