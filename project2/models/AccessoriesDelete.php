 ...
 * Page class
 */
#[AsAlias("AccessoriesDelete", true)]
class AccessoriesDelete extends Accessories implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "AccessoriesDelete"; // Route action
    ...
    public function run(): void
    {
        ...
        if (empty($this->Records) && !$this->CurrentRecord) {
            $this->terminate("AccessoriesList"); // Prevent SQL injection, return to list
            return;
        }
