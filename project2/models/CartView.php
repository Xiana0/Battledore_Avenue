 ...
 * Page class
 */
#[AsAlias("CartView", true)]
class CartView extends Cart implements PageInterface
{
    use MessagesTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "CartView"; // Route action
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CartList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->CurrentRecord) { // No current record
                    ...
                    $this->terminate("CartList"); // Return to list page
                    return;
