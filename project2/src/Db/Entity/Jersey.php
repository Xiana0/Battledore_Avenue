...
/**
 * Entity class for 'jerseys' table
 */
#[Entity]
#[Table('jerseys')]
class Jersey extends BaseEntity
{
    #[Id]
    ...
    #[Column(name: 'jersey_name', type: 'string')]
    ...
    public function getJerseyName(): string
    {
        return HtmlDecode($this->jerseyName);
    }

    public function setJerseyName(string $value): static
    {
        $this->jerseyName = RemoveXss($value);
        return $this;
    }
