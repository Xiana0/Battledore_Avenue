...
<?= $Page->getHtmlMessage() ?>
<main class="view">
<form name="fadminsview" id="fadminsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script<?= Nonce() ?>>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_admins_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->admin_id->Visible) { // admin_id ?>
    <tr id="r_admin_id"<?= $Page->admin_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_admins_admin_id"><?= $Page->admin_id->caption() ?></span></td>
...
<?php if ($Page->password->Visible) { // password ?>
    <tr id="r_password"<?= $Page->password->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_admins_password"><?= $Page->password->caption() ?></span></td>
