...
<body>
    ...
    <section class="shop">
        ...
        <div class="product-grid">
            ...
            <div class="product">
                <img src="ALPSPORT RR Badminton.jpg" alt="Jersey" class="product-img">

                <h3>ALPSPORT RR Badminton</h3>
                <p>₱50</p>

                <button onclick="openModal('ALPSPORT RR Badminton', 50, 'LD3 Qualifiers.jpg')">
                    Add to Cart
                </button>
            </div>
    ...
    <div id="checkoutModal" class="modal">
        <div class="modal-box">
            ...
            <label>Rental Duration (Hour/s)</label>
            <input type="text" id="rentingday" placeholder="e.g. 1">
